...
import loopCurrentBtn from './loop_current~becmfmpq.png';
import loopNoneBtn from './loop_none~beQtXZXI.png';
import previousBtn from './previous~HcmvNVfM.png';
import playBtn from './play~HzjgLbtN.png';
import pauseBtn from './pause~oJHQXTCg.png';
import nextBtn from './next~bgHcmLNb.png';
import shuffleAllBtn from './shuffle_all~iYpDLHuL.png';
import shuffleNoneBtn from './shuffle_none~rRNEYewC.png';
...
var LoopCurrent = function LoopCurrent(props) {
  return /*#__PURE__*/React.createElement("img", {
    className: styles$7.loop_current,
    src: props.src,
...
var Player = function Player(_ref) {
  ...
  var isInitialFilter = useRef(true);
  useEffect(function () {
  ...
  return /*#__PURE__*/React.createElement(PageTemplate, null, /*#__PURE__*/React.createElement(GlobalStyles, null), includeTags && /*#__PURE__*/React.createElement(TagsTemplate, null, tags.map(function (tag, index) {
  ...
  })), includeSearch && /*#__PURE__*/React.createElement(Search, {
    value: query,
    onChange: function onChange(e) {
      return updateQuery(e.target.value.toLowerCase());
    },
    placeholder: "Search " + trackList.length + " tracks..."
  }), /*#__PURE__*/React.createElement(PlayerTemplate, null, /*#__PURE__*/React.createElement("div", {
    className: styles.title_time_wrapper
  ...
  }, /*#__PURE__*/React.createElement(ButtonsBox, null, /*#__PURE__*/React.createElement(LoopCurrent, {
  ...
  }))), showPlaylist && /*#__PURE__*/React.createElement(PlaylistTemplate, null, trackList.sort(function (a, b) {
