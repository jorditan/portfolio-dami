...
var loopCurrentBtn = _interopDefault(require('./loop_current~becmfmpq.png'));
var loopNoneBtn = _interopDefault(require('./loop_none~beQtXZXI.png'));
var previousBtn = _interopDefault(require('./previous~HcmvNVfM.png'));
var playBtn = _interopDefault(require('./play~HzjgLbtN.png'));
var pauseBtn = _interopDefault(require('./pause~oJHQXTCg.png'));
var nextBtn = _interopDefault(require('./next~bgHcmLNb.png'));
var shuffleAllBtn = _interopDefault(require('./shuffle_all~iYpDLHuL.png'));
var shuffleNoneBtn = _interopDefault(require('./shuffle_none~rRNEYewC.png'));
