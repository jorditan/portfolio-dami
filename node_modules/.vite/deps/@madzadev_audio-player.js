...
// node_modules/@madzadev/audio-player/dist/index.modern.js
var import_react2 = __toESM(require_react());
import loopCurrentBtn from "D:/Desarrollo React/portfolio-damian/node_modules/@madzadev/audio-player/dist/loop_current~becmfmpq.png";
import loopNoneBtn from "D:/Desarrollo React/portfolio-damian/node_modules/@madzadev/audio-player/dist/loop_none~beQtXZXI.png";
import previousBtn from "D:/Desarrollo React/portfolio-damian/node_modules/@madzadev/audio-player/dist/previous~HcmvNVfM.png";
import playBtn from "D:/Desarrollo React/portfolio-damian/node_modules/@madzadev/audio-player/dist/play~HzjgLbtN.png";
import pauseBtn from "D:/Desarrollo React/portfolio-damian/node_modules/@madzadev/audio-player/dist/pause~oJHQXTCg.png";
import nextBtn from "D:/Desarrollo React/portfolio-damian/node_modules/@madzadev/audio-player/dist/next~bgHcmLNb.png";
import shuffleAllBtn from "D:/Desarrollo React/portfolio-damian/node_modules/@madzadev/audio-player/dist/shuffle_all~iYpDLHuL.png";
import shuffleNoneBtn from "D:/Desarrollo React/portfolio-damian/node_modules/@madzadev/audio-player/dist/shuffle_none~rRNEYewC.png";
...
var PageTemplate = function PageTemplate2(_ref) {
...
var PlayerTemplate = function PlayerTemplate2(_ref) {
  var children = _ref.children;
  return import_react2.default.createElement("div", {
...
var Title = function Title2(props) {
  return import_react2.default.createElement("h1", {
    className: styles$3.title
  }, props.title);
};
var styles$4 = { "time": "_tAQkw" };
var Time = function Time2(props) {
  return import_react2.default.createElement("h1", {
...
var ButtonsBox = function ButtonsBox2(_ref) {
  var children = _ref.children;
  return import_react2.default.createElement("div", {
...
var LoopCurrent = function LoopCurrent2(props) {
...
var Previous = function Previous2(props) {
  return import_react2.default.createElement("img", {
...
var Pause = function Pause2(props) {
  return import_react2.default.createElement("img", {
...
var Shuffle = function Shuffle2(props) {
  return import_react2.default.createElement("img", {
...
var Volume = function Volume2(props) {
  return import_react2.default.createElement("div", {
...
var PlaylistTemplate = function PlaylistTemplate2(_ref) {
  var children = _ref.children;
  return import_react2.default.createElement("div", {
...
var PlaylistItem = function PlaylistItem2(props) {
  return import_react2.default.createElement("p", {
...
var TagsTemplate = function TagsTemplate2(_ref) {
  var children = _ref.children;
  return import_react2.default.createElement("div", {
...
var TagItem = function TagItem2(props) {
  return import_react2.default.createElement("div", {
...
var Search = function Search2(_ref) {
  var onChange = _ref.onChange, value = _ref.value, placeholder = _ref.placeholder;
  return import_react2.default.createElement("div", {
...
var Player = function Player2(_ref) {
  var trackList = _ref.trackList, _ref$includeTags = _ref.includeTags, includeTags = _ref$includeTags === void 0 ? true : _ref$includeTags, _ref$includeSearch = _ref.includeSearch, includeSearch = _ref$includeSearch === void 0 ? true : _ref$includeSearch, _ref$showPlaylist = _ref.showPlaylist, showPlaylist = _ref$showPlaylist === void 0 ? true : _ref$showPlaylist, _ref$autoPlayNextTrac = _ref.autoPlayNextTrack, autoPlayNextTrack = _ref$autoPlayNextTrac === void 0 ? true : _ref$autoPlayNextTrac, _ref$customColorSchem = _ref.customColorScheme, customColorScheme = _ref$customColorSchem === void 0 ? colors : _ref$customColorSchem;
  var _useState = (0, import_react2.useState)(""), query = _useState[0], updateQuery = _useState[1];
  var playlist = [];
  var _useState2 = (0, import_react2.useState)(null), audio = _useState2[0], setAudio = _useState2[1];
  var _useState3 = (0, import_react2.useState)(false), active = _useState3[0], setActive = _useState3[1];
  var _useState4 = (0, import_react2.useState)(""), title = _useState4[0], setTitle = _useState4[1];
  var _useState5 = (0, import_react2.useState)(0), length = _useState5[0], setLength = _useState5[1];
  var _useState6 = (0, import_react2.useState)(0), time = _useState6[0], setTime = _useState6[1];
  var _useState7 = (0, import_react2.useState)(1), slider = _useState7[0], setSlider = _useState7[1];
  var _useState8 = (0, import_react2.useState)(0), drag = _useState8[0], setDrag = _useState8[1];
  var _useState9 = (0, import_react2.useState)(0.8), volume = _useState9[0], setVolume = _useState9[1];
  var _useState10 = (0, import_react2.useState)(0), end = _useState10[0], setEnd = _useState10[1];
  var _useState11 = (0, import_react2.useState)(false), shuffled = _useState11[0], setShuffled = _useState11[1];
  var _useState12 = (0, import_react2.useState)(false), looped = _useState12[0], setLooped = _useState12[1];
  var _useState13 = (0, import_react2.useState)([]), filter = _useState13[0], setFilter = _useState13[1];
  var _useState14 = (0, import_react2.useState)(0), curTrack = _useState14[0], setCurTrack = _useState14[1];
  var GlobalStyles = $e(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n", "\n"])), customColorScheme);
  var fmtMSS = function fmtMSS2(s2) {
    return new Date(1e3 * s2).toISOString().substr(15, 4);
  };
  (0, import_react2.useEffect)(function() {
    var audio2 = new Audio(trackList[curTrack].url);
    var setAudioData = function setAudioData2() {
      setLength(audio2.duration);
      setTime(audio2.currentTime);
    };
    var setAudioTime = function setAudioTime2() {
      var curTime = audio2.currentTime;
      setTime(curTime);
      setSlider(curTime ? (curTime * 100 / audio2.duration).toFixed(1) : 0);
    };
    var setAudioVolume = function setAudioVolume2() {
      return setVolume(audio2.volume);
    };
    var setAudioEnd = function setAudioEnd2() {
      return setEnd(end += 1);
    };
    audio2.addEventListener("loadeddata", setAudioData);
    audio2.addEventListener("timeupdate", setAudioTime);
    audio2.addEventListener("volumechange", setAudioVolume);
    audio2.addEventListener("ended", setAudioEnd);
    setAudio(audio2);
  ...
  var shufflePlaylist = function shufflePlaylist2(arr) {
    if (arr.length === 1)
      return arr;
    var rand = Math.floor(Math.random() * arr.length);
    return [arr[rand]].concat(shufflePlaylist2(arr.filter(function(_2, i2) {
      return i2 != rand;
    })));
  };
  var isInitialMount = (0, import_react2.useRef)(true);
  (0, import_react2.useEffect)(function() {
  ...
  var shuffle = function shuffle2() {
    setShuffled(!shuffled);
  };
  var playlistItemClickHandler = function playlistItemClickHandler2(e2) {
    var num = Number(e2.currentTarget.getAttribute("data-key"));
    var index = playlist.indexOf(num);
    setCurTrack(curTrack = playlist[index]);
    play();
  };
  var isInitialFilter = (0, import_react2.useRef)(true);
  (0, import_react2.useEffect)(function() {
  ...
  var tagClickHandler = function tagClickHandler2(e2) {
    var tag = e2.currentTarget.innerHTML;
  ...
  return import_react2.default.createElement(PageTemplate, null, import_react2.default.createElement(GlobalStyles, null), includeTags && import_react2.default.createElement(TagsTemplate, null, tags.map(function(tag, index) {
    return import_react2.default.createElement(TagItem, {
      key: index,
      className: filter.length !== 0 && filter.includes(tag) ? "active" : "",
      tag,
      onClick: tagClickHandler
    });
  })), includeSearch && import_react2.default.createElement(Search, {
    value: query,
    onChange: function onChange(e2) {
      return updateQuery(e2.target.value.toLowerCase());
    },
    placeholder: "Search " + trackList.length + " tracks..."
  }), import_react2.default.createElement(PlayerTemplate, null, import_react2.default.createElement("div", {
    className: styles.title_time_wrapper
  }, import_react2.default.createElement(Title, {
    title
  }), import_react2.default.createElement(Time, {
    time: (!time ? "0:00" : fmtMSS(time)) + "/" + (!length ? "0:00" : fmtMSS(length))
  })), import_react2.default.createElement(Progress, {
    value: slider,
    onChange: function onChange(e2) {
      setSlider(e2.target.value);
      setDrag(e2.target.value);
    },
    onMouseUp: play,
    onTouchEnd: play
  }), import_react2.default.createElement("div", {
    className: styles.buttons_volume_wrapper
  }, import_react2.default.createElement(ButtonsBox, null, import_react2.default.createElement(LoopCurrent, {
    src: looped ? loopCurrentBtn : loopNoneBtn,
    onClick: loop
  }), import_react2.default.createElement(Previous, {
    src: previousBtn,
    onClick: previous
  }), active ? import_react2.default.createElement(Pause, {
    src: pauseBtn,
    onClick: pause
  }) : import_react2.default.createElement(Play, {
    src: playBtn,
    onClick: play
  }), import_react2.default.createElement(Next, {
    src: nextBtn,
    onClick: next
  }), import_react2.default.createElement(Shuffle, {
    src: shuffled ? shuffleAllBtn : shuffleNoneBtn,
    onClick: shuffle
  })), import_react2.default.createElement(Volume, {
    value: volume,
    onChange: function onChange(e2) {
      setVolume(e2.target.value / 100);
    }
  }))), showPlaylist && import_react2.default.createElement(PlaylistTemplate, null, trackList.sort(function(a2, b2) {
    return a2.title > b2.title ? 1 : -1;
  }).map(function(el, index) {
    if (filter.length === 0 || filter.some(function(filter2) {
      return el.tags.includes(filter2);
    })) {
      if (el.title.toLowerCase().includes(query.toLowerCase())) {
        playlist.push(index);
        return import_react2.default.createElement(PlaylistItem, {
...
var index_modern_default = Player;
export {
  index_modern_default as default
};
//# sourceMappingURL=@madzadev_audio-player.js.map
