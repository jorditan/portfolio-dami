     ...
     return (
          <section id="contenedorModalidades">
               <div className="contenedorTexto">
                    <h2 className="text-5xl text-[#303030] font-bold">¡Hacé click en los botones y descubrí las características de cada modalidad!</h2>
               ...
               <div className="contenedorDetails w-3/4 flex column pt-12">
                    <p className="text-[#303030] font-semibold text-sm">Para empezar a tomar clases de música comunicate conmigo por redes sociales o por mi <a className="font-bold hover:text-[#1d1d1d]" href="https://wa.link/oy03d9" target="blank">WhatsApp</a></p>
